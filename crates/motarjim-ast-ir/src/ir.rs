...
pub struct IrNode {
    ...
    pub id: motarjim_ast_html::NodeId,
    /// The semantic IR.
    ...
    pub computed_style: motarjim_ast_html::ComputedStyle,
...
pub struct IrTree {
    ...
    pub root_id: motarjim_ast_html::NodeId,
...
mod tests {
    ...
    fn make_ir_node(id: u32, semantic: SemanticIr, layout: LayoutIr) -> IrNode {
        IrNode {
            id: motarjim_ast_html::NodeId(id),
            semantic,
            layout,
    ...
    fn test_ir_node() {
        ...
        assert_eq!(node.id, motarjim_ast_html::NodeId(0));
    ...
    fn test_ir_tree() {
        let tree = IrTree {
            ...
            root_id: motarjim_ast_html::NodeId(0),
            target_hints: vec![],
        };
        assert_eq!(tree.nodes.len(), 1);
        assert_eq!(tree.root_id, motarjim_ast_html::NodeId(0));
    }
    ...
    fn test_ir_node_parent_child() {
        ...
        parent.children.push(motarjim_ast_html::NodeId(1));
