...
graph TD
    ...
    motarjim_ast_css[[motarjim-ast-css]]
    motarjim_ast_html[[motarjim-ast-html]]
    motarjim_ast_ir[[motarjim-ast-ir]]
    ...
    motarjim_errors[[motarjim-errors]]
    ...
    motarjim_session[[motarjim-session]]
    motarjim_span[[motarjim-span]]
    motarjim_test_utils[[motarjim-test-utils]]
    motarjim_wasm[[motarjim-wasm]]

    motarjim_ast --> motarjim_ast_css
    motarjim_ast --> motarjim_ast_html
    motarjim_ast --> motarjim_ast_ir
    motarjim_ast --> motarjim_span
    motarjim_ast_css --> motarjim_ast_html
    motarjim_ast_css --> motarjim_span
    motarjim_ast_ir --> motarjim_ast_css
    motarjim_ast_ir --> motarjim_ast_html
    motarjim_cache --> motarjim_diag
    motarjim_cache --> motarjim_fs
    motarjim_cache --> motarjim_serialize
    motarjim_cache --> motarjim_span
    motarjim_cli --> motarjim_config
    motarjim_cli --> motarjim_core
    motarjim_cli --> motarjim_diag
    motarjim_cli --> motarjim_fs
    motarjim_cli --> motarjim_js
    motarjim_cli --> motarjim_profiling
    motarjim_cli --> motarjim_span
    motarjim_config --> motarjim_diag
    motarjim_config --> motarjim_fs
    motarjim_config --> motarjim_span
    motarjim_core --> motarjim_ast
    motarjim_core --> motarjim_ast_html
    ...
    motarjim_core --> motarjim_session
    motarjim_core --> motarjim_span
    motarjim_css --> motarjim_ast
    motarjim_css --> motarjim_ast_css
    motarjim_css --> motarjim_ast_html
    motarjim_css --> motarjim_diag
    motarjim_css --> motarjim_lexer
    motarjim_css --> motarjim_selectors
    motarjim_css --> motarjim_span
    motarjim_diag --> motarjim_errors
    motarjim_diag --> motarjim_span
    motarjim_errors --> motarjim_span
    ...
    motarjim_lsp --> motarjim_span
    motarjim_optimizer --> motarjim_ast
    motarjim_optimizer --> motarjim_ast_html
    motarjim_optimizer --> motarjim_diag
    motarjim_optimizer --> motarjim_span
    motarjim_parser --> motarjim_ast
    motarjim_parser --> motarjim_ast_css
    motarjim_parser --> motarjim_diag
    motarjim_parser --> motarjim_lexer
    motarjim_parser --> motarjim_span
    motarjim_selectors --> motarjim_ast
    motarjim_selectors --> motarjim_diag
    motarjim_selectors --> motarjim_span
    motarjim_serialize --> motarjim_ast
    motarjim_serialize --> motarjim_ast_html
    motarjim_session --> motarjim_cache
    motarjim_session --> motarjim_config
    motarjim_session --> motarjim_diag
    motarjim_session --> motarjim_fs
    motarjim_session --> motarjim_incremental
    motarjim_session --> motarjim_profiling
    motarjim_session --> motarjim_span
